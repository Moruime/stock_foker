...
**更新** 新增 LPR（贷款市场报价利率）、M2（广义货币供应量）和 Shibor（上海银行间同业拆放利率）三个关键宏观经济指标，显著增强了数据展示能力和分析深度。
...
### 1. 宏观页面组件 (MacroPage)
负责展示宏观经济分析结果的前端组件，集成了多个数据面板和交互功能。**更新** 布局重构为 flex 一行居中，提升了视觉效果和用户体验。
...
**更新** 新增的 LPR、M2、Shibor 三个关键宏观经济指标显著增强了数据展示能力和分析深度，flex 布局重构提升了用户体验和视觉效果。
...
**更新** 布局重构和指标增强为后续的功能扩展奠定了良好基础，flex 一行居中布局为未来更多的指标展示提供了良好的视觉基础。
