...
- [doc/待办列表/2026-04-14-data-display-enhancement.md](file://doc/待办列表/2026-04-14-data-display-enhancement.md)
...
### 1. 宏观页面组件 (MacroPage)
负责展示宏观经济分析结果的前端组件，集成了多个数据面板和交互功能。
